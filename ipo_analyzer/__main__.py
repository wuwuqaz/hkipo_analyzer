...
def main():
    ...
    reanalyze_parser.add_argument("--margin-total", type=float, default=None, help="孖展资金总计（亿）")
    reanalyze_parser.add_argument("--public-offer", type=float, default=None, help="公开集资额（亿）")
